(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("moment"), require("react-onclickoutside"));
	else if(typeof define === 'function' && define.amd)
		define(["moment", "react-onclickoutside"], factory);
	else if(typeof exports === 'object')
		exports["DatePicker"] = factory(require("moment"), require("react-onclickoutside"));
	else
		root["DatePicker"] = factory(root["moment"], root["OnClickOutside"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tether_component = __webpack_require__(12);
	...
	var _date_utils = __webpack_require__(3);
	...
	var DatePicker = React.createClass({
	  ...
	  renderCalendar: function renderCalendar() {
	    ...
	    return React.createElement(_calendar2.default, {
	      ref: 'calendar',
	  ...
	  renderDateInput: function renderDateInput() {
	    ...
	    return React.createElement(_date_input2.default, {
	      ref: 'input',
	      id: this.props.id,
	  ...
	  renderClearButton: function renderClearButton() {
	    if (this.props.isClearable && this.props.selected != null) {
	      return React.createElement('a', { className: 'react-datepicker__close-icon', href: '#', onClick: this.onClearClick });
	    } else {
	      return null;
	    }
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _year_dropdown = __webpack_require__(5);
	...
	var Calendar = React.createClass({
	  ...
	  renderYearDropdown: function renderYearDropdown() {
	    ...
	    return React.createElement(_year_dropdown2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _year_dropdown_options = __webpack_require__(6);
	...
	var YearDropdown = React.createClass({
	  ...
	  renderDropdown: function renderDropdown() {
	    return React.createElement(_year_dropdown_options2.default, {
	      ref: 'options',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TetherComponent = React.createClass({
	  ...
	  _update: function _update() {
	    ...
	    ReactDOM.unstable_renderSubtreeIntoContainer(this, elementComponent, this._elementParentNode, function () {
